...
function HdtDatasource(options) {
  ...
  // Test wether the metadata file exists
  var metadataFile = (options.metadataFile || hdtFile + '.metadata').replace(/^file:\/\//, '');
  if (!fs.existsSync(metadataFile))
    throw Error('Not a valid metadata file: ' + metadataFile);
  ...
  hdt.fromFile(hdtFile, metadataFile, function (error, hdtDocument) {
